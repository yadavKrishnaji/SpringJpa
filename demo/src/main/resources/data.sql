...
insert into course(id,name,last_updated_date,created_date) values(10003,'Spring boot in 100 steps',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
...
insert into review(id,rating,description,course_id) values(50001,'5','Greate Course', 10001);
